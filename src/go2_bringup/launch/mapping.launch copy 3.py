...
def generate_launch_description():
    ...
    rtabmap_node = Node(
        ...
        arguments=[
            ...
            # Slow detection loop a little & cap features
            "Rtabmap/DetectionRate","5.0",   # map update Hz
            "Kp/DetectorStrategy","6",       # ORB
            "Kp/MaxFeatures","400",

            # Don’t add nodes unless you’ve actually moved (cuts DB churn)
