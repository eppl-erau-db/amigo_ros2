...
class OdomNode(Node):
    def __init__(self):
        ...
        self.odom_subscriber = self.create_subscription(Odometry, "/filtered_odom", self.odom_callback, 10)
        self.odometry_publisher = self.create_publisher(Odometry, '/robot_odom', 10)
        # self.broadcaster = TransformBroadcaster(self, qos=50)
