...
bool isaac_ros_pointcloud_interfaces__msg__flat_scan__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("isaac_ros_pointcloud_interfaces.msg._flat_scan.FlatScan", full_classname_dest, 55) == 0);
  }
  isaac_ros_pointcloud_interfaces__msg__FlatScan * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of FlatScan */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("isaac_ros_pointcloud_interfaces.msg._flat_scan");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FlatScan");
