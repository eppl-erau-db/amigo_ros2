...
#include "nvblox_msgs/srv/detail/file_path__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nvblox_msgs::srv::FilePath_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nvblox_msgs::srv::FilePath_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nvblox_msgs::srv::FilePath_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FilePath_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const nvblox_msgs::srv::FilePath_Request *>(
...
static size_t _FilePath_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FilePath_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FilePath_Request__callbacks = {
  "nvblox_msgs::srv",
  "FilePath_Request",
...
static rosidl_message_type_support_t _FilePath_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FilePath_Request__callbacks,
...
{
  return &nvblox_msgs::srv::typesupport_fastrtps_cpp::_FilePath_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = nvblox_msgs::srv::FilePath_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nvblox_msgs::srv::FilePath_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<nvblox_msgs::srv::FilePath_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FilePath_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const nvblox_msgs::srv::FilePath_Response *>(
...
static size_t _FilePath_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FilePath_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FilePath_Response__callbacks = {
  "nvblox_msgs::srv",
  "FilePath_Response",
...
static rosidl_message_type_support_t _FilePath_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FilePath_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &nvblox_msgs::srv::typesupport_fastrtps_cpp::_FilePath_Response__handle;
}
...
static service_type_support_callbacks_t _FilePath__callbacks = {
  "nvblox_msgs::srv",
  "FilePath",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nvblox_msgs, srv, FilePath_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nvblox_msgs, srv, FilePath_Response)(),
...
static rosidl_service_type_support_t _FilePath__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FilePath__callbacks,
...
{
  return &nvblox_msgs::srv::typesupport_fastrtps_cpp::_FilePath__handle;
}
