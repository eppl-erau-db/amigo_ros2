...
#include "nvblox_msgs/msg/detail/mesh_block__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: triangles
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.triangles[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nvblox_msgs::msg::MeshBlock;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nvblox_msgs::msg::MeshBlock *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nvblox_msgs::msg::MeshBlock *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MeshBlock__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const nvblox_msgs::msg::MeshBlock *>(
...
static size_t _MeshBlock__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MeshBlock(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MeshBlock__callbacks = {
  "nvblox_msgs::msg",
  "MeshBlock",
...
static rosidl_message_type_support_t _MeshBlock__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MeshBlock__callbacks,
...
{
  return &nvblox_msgs::msg::typesupport_fastrtps_cpp::_MeshBlock__handle;
}
