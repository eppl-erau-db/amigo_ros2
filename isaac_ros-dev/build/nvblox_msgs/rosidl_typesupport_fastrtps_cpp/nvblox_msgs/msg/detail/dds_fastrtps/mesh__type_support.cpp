...
#include "nvblox_msgs/msg/detail/mesh__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const nvblox_msgs::msg::MeshBlock &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const nvblox_msgs::msg::Mesh & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: block_indices
  {
    ...
    for (size_t i = 0; i < size; i++) {
      nvblox_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.block_indices[i],
        cdr);
    }
  }
  // Member: blocks
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nvblox_msgs::msg::Mesh & ros_message)
{
  // Member: header
  ...
  // Member: block_indices
  {
    ...
    ros_message.block_indices.resize(size);
    for (size_t i = 0; i < size; i++) {
      nvblox_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.block_indices[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: block_indices
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        nvblox_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.block_indices[index], current_alignment);
    }
  }
  // Member: blocks
  {
  ...
  size_t current_alignment)
{
  ...
  // Member: block_indices
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        nvblox_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Index3D(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: blocks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        nvblox_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MeshBlock(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = nvblox_msgs::msg::Mesh;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nvblox_msgs::msg::Mesh *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nvblox_msgs::msg::Mesh *>(
    untyped_ros_message);
...
{
  return &nvblox_msgs::msg::typesupport_fastrtps_cpp::_Mesh__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nvblox_msgs, msg, Mesh)() {
  return &nvblox_msgs::msg::typesupport_fastrtps_cpp::_Mesh__handle;
}
