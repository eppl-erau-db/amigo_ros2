...
#ifndef NVBLOX_MSGS__SRV__DETAIL__FILE_PATH__FUNCTIONS_H_
#define NVBLOX_MSGS__SRV__DETAIL__FILE_PATH__FUNCTIONS_H_
 ...
 * calls
 * nvblox_msgs__srv__FilePath_Request__init().
...
/**
 * It calls
 * nvblox_msgs__srv__FilePath_Request__fini()
 ...
 * nvblox_msgs__srv__FilePath_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * nvblox_msgs__srv__FilePath_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * nvblox_msgs__srv__FilePath_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_nvblox_msgs
...
/**
 * It calls
 * nvblox_msgs__srv__FilePath_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_nvblox_msgs
...
/**
 * It allocates the memory for the array and calls
 * nvblox_msgs__srv__FilePath_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_nvblox_msgs
...
/**
 * It calls
 * nvblox_msgs__srv__FilePath_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // NVBLOX_MSGS__SRV__DETAIL__FILE_PATH__FUNCTIONS_H_
