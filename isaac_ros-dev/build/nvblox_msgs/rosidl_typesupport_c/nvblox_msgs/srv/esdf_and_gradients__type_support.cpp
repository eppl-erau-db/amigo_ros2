...
static const _EsdfAndGradients_Request_type_support_symbol_names_t _EsdfAndGradients_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nvblox_msgs, srv, EsdfAndGradients_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nvblox_msgs, srv, EsdfAndGradients_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nvblox_msgs, srv, EsdfAndGradients_Request)() {
  return &::nvblox_msgs::srv::rosidl_typesupport_c::EsdfAndGradients_Request_message_type_support_handle;
}
...
static const _EsdfAndGradients_Response_type_support_symbol_names_t _EsdfAndGradients_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nvblox_msgs, srv, EsdfAndGradients_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nvblox_msgs, srv, EsdfAndGradients_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, nvblox_msgs, srv, EsdfAndGradients_Response)() {
  return &::nvblox_msgs::srv::rosidl_typesupport_c::EsdfAndGradients_Response_message_type_support_handle;
}
...
static const _EsdfAndGradients_type_support_symbol_names_t _EsdfAndGradients_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nvblox_msgs, srv, EsdfAndGradients)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nvblox_msgs, srv, EsdfAndGradients)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, nvblox_msgs, srv, EsdfAndGradients)() {
  return &::nvblox_msgs::srv::rosidl_typesupport_c::EsdfAndGradients_service_type_support_handle;
}
