...
bool nvblox_msgs__msg__distance_map_slice__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nvblox_msgs.msg._distance_map_slice.DistanceMapSlice", full_classname_dest, 52) == 0);
  }
  nvblox_msgs__msg__DistanceMapSlice * ros_message = _ros_message;
  {  // header
  ...
  {  // unknown_value
    PyObject * field = PyObject_GetAttrString(_pymsg, "unknown_value");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->unknown_value = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // data
...
{
  /* NOTE(esteve): Call constructor of DistanceMapSlice */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nvblox_msgs.msg._distance_map_slice");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DistanceMapSlice");
  ...
  {  // unknown_value
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->unknown_value);
    {
      int rc = PyObject_SetAttrString(_pymessage, "unknown_value", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
