...
bool nvblox_msgs__msg__index3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nvblox_msgs.msg._index3_d.Index3D", full_classname_dest, 33) == 0);
  }
  nvblox_msgs__msg__Index3D * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of Index3D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nvblox_msgs.msg._index3_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Index3D");
