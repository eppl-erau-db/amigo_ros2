...
static const _AprilTagDetection_type_support_symbol_names_t _AprilTagDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, isaac_ros_apriltag_interfaces, msg, AprilTagDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, isaac_ros_apriltag_interfaces, msg, AprilTagDetection)),
  }
};
...
{
  return &::isaac_ros_apriltag_interfaces::msg::rosidl_typesupport_cpp::AprilTagDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, isaac_ros_apriltag_interfaces, msg, AprilTagDetection)() {
  return get_message_type_support_handle<isaac_ros_apriltag_interfaces::msg::AprilTagDetection>();
}
