...
static const _AprilTagDetectionArray_type_support_symbol_names_t _AprilTagDetectionArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, isaac_ros_apriltag_interfaces, msg, AprilTagDetectionArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, isaac_ros_apriltag_interfaces, msg, AprilTagDetectionArray)),
  }
};
...
{
  return &::isaac_ros_apriltag_interfaces::msg::rosidl_typesupport_cpp::AprilTagDetectionArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, isaac_ros_apriltag_interfaces, msg, AprilTagDetectionArray)() {
  return get_message_type_support_handle<isaac_ros_apriltag_interfaces::msg::AprilTagDetectionArray>();
}
