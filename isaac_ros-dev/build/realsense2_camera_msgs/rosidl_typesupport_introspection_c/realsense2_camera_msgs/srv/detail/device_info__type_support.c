...
static rosidl_typesupport_introspection_c__MessageMember realsense2_camera_msgs__srv__DeviceInfo_Response__rosidl_typesupport_introspection_c__DeviceInfo_Response_message_member_array[6] = {
  {
    "device_name",  // name
