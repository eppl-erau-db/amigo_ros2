...
#include "isaac_ros_bi3d_interfaces/msg/detail/bi3_d_inference_parameters_array__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.disparity_values;
  }
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: disparity_values
  {
    ...
    size_t item_size = sizeof(ros_message.disparity_values[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = isaac_ros_bi3d_interfaces::msg::Bi3DInferenceParametersArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const isaac_ros_bi3d_interfaces::msg::Bi3DInferenceParametersArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<isaac_ros_bi3d_interfaces::msg::Bi3DInferenceParametersArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Bi3DInferenceParametersArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const isaac_ros_bi3d_interfaces::msg::Bi3DInferenceParametersArray *>(
...
static size_t _Bi3DInferenceParametersArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Bi3DInferenceParametersArray(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Bi3DInferenceParametersArray__callbacks = {
...
static rosidl_message_type_support_t _Bi3DInferenceParametersArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Bi3DInferenceParametersArray__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_isaac_ros_bi3d_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<isaac_ros_bi3d_interfaces::msg::Bi3DInferenceParametersArray>()
{
  return &isaac_ros_bi3d_interfaces::msg::typesupport_fastrtps_cpp::_Bi3DInferenceParametersArray__handle;
}
