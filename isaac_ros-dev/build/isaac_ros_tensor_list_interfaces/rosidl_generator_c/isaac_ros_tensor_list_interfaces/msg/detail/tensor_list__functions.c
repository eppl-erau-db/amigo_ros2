...
isaac_ros_tensor_list_interfaces__msg__TensorList__init(isaac_ros_tensor_list_interfaces__msg__TensorList * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    isaac_ros_tensor_list_interfaces__msg__TensorList__fini(msg);
    return false;
  }
  // tensors
...
isaac_ros_tensor_list_interfaces__msg__TensorList__create()
{
  ...
  isaac_ros_tensor_list_interfaces__msg__TensorList * msg = (isaac_ros_tensor_list_interfaces__msg__TensorList *)allocator.allocate(sizeof(isaac_ros_tensor_list_interfaces__msg__TensorList), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(isaac_ros_tensor_list_interfaces__msg__TensorList));
  bool success = isaac_ros_tensor_list_interfaces__msg__TensorList__init(msg);
  if (!success) {
...
isaac_ros_tensor_list_interfaces__msg__TensorList__Sequence__init(isaac_ros_tensor_list_interfaces__msg__TensorList__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  isaac_ros_tensor_list_interfaces__msg__TensorList * data = NULL;

  if (size) {
    data = (isaac_ros_tensor_list_interfaces__msg__TensorList *)allocator.zero_allocate(size, sizeof(isaac_ros_tensor_list_interfaces__msg__TensorList), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = isaac_ros_tensor_list_interfaces__msg__TensorList__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        isaac_ros_tensor_list_interfaces__msg__TensorList__fini(&data[i - 1]);
      }
...
isaac_ros_tensor_list_interfaces__msg__TensorList__Sequence__fini(isaac_ros_tensor_list_interfaces__msg__TensorList__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      isaac_ros_tensor_list_interfaces__msg__TensorList__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  isaac_ros_tensor_list_interfaces__msg__TensorList__Sequence * array = (isaac_ros_tensor_list_interfaces__msg__TensorList__Sequence *)allocator.allocate(sizeof(isaac_ros_tensor_list_interfaces__msg__TensorList__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = isaac_ros_tensor_list_interfaces__msg__TensorList__Sequence__init(array, size);
  if (!success) {
...
isaac_ros_tensor_list_interfaces__msg__TensorList__Sequence__destroy(isaac_ros_tensor_list_interfaces__msg__TensorList__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    isaac_ros_tensor_list_interfaces__msg__TensorList__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
isaac_ros_tensor_list_interfaces__msg__TensorList__Sequence__are_equal(const isaac_ros_tensor_list_interfaces__msg__TensorList__Sequence * lhs, const isaac_ros_tensor_list_interfaces__msg__TensorList__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!isaac_ros_tensor_list_interfaces__msg__TensorList__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  isaac_ros_tensor_list_interfaces__msg__TensorList__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(isaac_ros_tensor_list_interfaces__msg__TensorList);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    isaac_ros_tensor_list_interfaces__msg__TensorList * data =
      (isaac_ros_tensor_list_interfaces__msg__TensorList *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!isaac_ros_tensor_list_interfaces__msg__TensorList__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          isaac_ros_tensor_list_interfaces__msg__TensorList__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!isaac_ros_tensor_list_interfaces__msg__TensorList__copy(
