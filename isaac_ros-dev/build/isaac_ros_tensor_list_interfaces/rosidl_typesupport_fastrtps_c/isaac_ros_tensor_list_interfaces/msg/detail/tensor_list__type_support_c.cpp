...
#include "isaac_ros_tensor_list_interfaces/msg/detail/tensor_list__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_isaac_ros_tensor_list_interfaces
...
using _TensorList__ros_msg_type = isaac_ros_tensor_list_interfaces__msg__TensorList;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TensorList__ros_msg_type * ros_message = static_cast<const _TensorList__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TensorList__ros_msg_type * ros_message = static_cast<_TensorList__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_isaac_ros_tensor_list_interfaces__msg__TensorList(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TensorList__ros_msg_type * ros_message = static_cast<const _TensorList__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TensorList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_isaac_ros_tensor_list_interfaces__msg__TensorList(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_isaac_ros_tensor_list_interfaces
size_t max_serialized_size_isaac_ros_tensor_list_interfaces__msg__TensorList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = isaac_ros_tensor_list_interfaces__msg__TensorList;
    is_plain =
      (
...
static size_t _TensorList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_isaac_ros_tensor_list_interfaces__msg__TensorList(
...
static message_type_support_callbacks_t __callbacks_TensorList = {
...
static rosidl_message_type_support_t _TensorList__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TensorList,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, isaac_ros_tensor_list_interfaces, msg, TensorList)() {
  return &_TensorList__type_support;
}
