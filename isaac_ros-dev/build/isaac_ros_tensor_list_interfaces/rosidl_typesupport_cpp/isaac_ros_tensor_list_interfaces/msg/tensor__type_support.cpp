...
static const _Tensor_type_support_symbol_names_t _Tensor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, isaac_ros_tensor_list_interfaces, msg, Tensor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, isaac_ros_tensor_list_interfaces, msg, Tensor)),
  }
};
...
{
  return &::isaac_ros_tensor_list_interfaces::msg::rosidl_typesupport_cpp::Tensor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, isaac_ros_tensor_list_interfaces, msg, Tensor)() {
  return get_message_type_support_handle<isaac_ros_tensor_list_interfaces::msg::Tensor>();
}
