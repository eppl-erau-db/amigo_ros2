...
bool unitree_api__msg__response_header__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unitree_api.msg._response_header.ResponseHeader", full_classname_dest, 47) == 0);
  }
  unitree_api__msg__ResponseHeader * ros_message = _ros_message;
  {  // identity
  ...
  {  // status
    ...
    if (!unitree_api__msg__response_status__convert_from_py(field, &ros_message->status)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * unitree_api__msg__response_header__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unitree_api.msg._response_header");
  ...
  {  // status
    PyObject * field = NULL;
    field = unitree_api__msg__response_status__convert_to_py(&ros_message->status);
    if (!field) {
      return NULL;
    }
    {
